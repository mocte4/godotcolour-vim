...
hi Conditional     guifg=#FF8CCC               gui=none"c
hi Constant        guifg=#CDCFD2               gui=none"c
hi Cursor          guifg=#000000 guibg=#F8F8F0
hi iCursor         guifg=#000000 guibg=#F8F8F0
hi Debug           guifg=#BCA3A3               gui=none"c
hi Define          guifg=#D1FDEE
hi Delimiter       guifg=#ABC9FF"c
hi DiffAdd                       guibg=#13354A
hi DiffChange      guifg=#89807D guibg=#4C4745
hi DiffDelete      guifg=#960050 guibg=#1E0010
hi DiffText                      guibg=#4C4745 gui=none"c removed italics (says when typing a command at the bottom)

hi Directory       guifg=#A6E22E               gui=none"c
hi Error           guifg=#E6DB74 guibg=#1E0010
hi ErrorMsg        guifg=#F92672 guibg=#232526 gui=none"c
hi Exception       guifg=#F92672               gui=none"c
...
hi Keyword         guifg=#FF7085               gui=none"c Vimscript doesn't appear to distinguish between flow control keywords and regular ones like Godot does so no pink :(
hi Label           guifg=#E6DB74               gui=none
hi Macro           guifg=#FFB373"c
hi SpecialKey      guifg=#42FFC2"c

hi MatchParen      guifg=#A3A3F5 guibg=bg      gui=none"c [parentheses4parliament](https://pingers4parliament.com/)
...
hi PreCondit       guifg=#A6E22E               gui=none"c
hi PreProc         guifg=#F92672
hi Question        guifg=#66D9EF
hi Repeat          guifg=#F92672               gui=none"c
hi Search          guifg=#000000 guibg=#FFE792"c
" marks
hi SignColumn      guifg=#A6E22E guibg=#232526
hi SpecialChar     guifg=#F92672               gui=none"c
hi SpecialComment  guifg=#8096AB               gui=none"c
...
hi Statement       guifg=#F92672               gui=none"c
...
hi Todo            guifg=#FFFFFF guibg=bg      gui=none"c

hi Typedef         guifg=#8FFFDB"c
hi Type            guifg=#8FFFDB               gui=none"c
hi Underlined      guifg=#63C259               gui=none"c

hi VertSplit       guifg=#808080 guibg=#080808 gui=none"c
hi VisualNOS                     guibg=#403D3D
hi Visual                        guibg=#403D3D
hi WarningMsg      guifg=#FFFFFF guibg=#333333 gui=none"c
hi WildMenu        guifg=#66D9EF guibg=#000000

hi TabLineFill     guifg=#1B1D1E guibg=#1B1D1E
hi TabLine         guibg=#1B1D1E guifg=#808080 gui=none"c
