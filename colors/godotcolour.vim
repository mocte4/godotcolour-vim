...
hi MatchParen      guifg=#000000 guibg=#FAE345 gui=bold"c pink sucks for this actually
...
hi Special         guifg=#73D1DC"c LIGHT BLUE RETURNS ...an interpolation between light green and dark purple
if has("spell")
    hi SpellBad    guisp=#FF0000 gui=undercurl
    hi SpellCap    guisp=#7070F0 gui=undercurl
    hi SpellLocal  guisp=#70F0F0 gui=undercurl
    hi SpellRare   guisp=#CDCFD2 gui=undercurl"c ############ KEEP AN EYE ON
endif
